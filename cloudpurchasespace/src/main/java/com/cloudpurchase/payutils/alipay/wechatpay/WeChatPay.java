package com.cloudpurchase.payutils.alipay.wechatpay;
...
public class WeChatPay {
    ...
    private IWXAPI api;
    private boolean isPaySupported;//判断手机安装地微信版本是否支持使用微信支付
     ...
     */
    private static final String APP_SECRET = "wxd930ea5d5a258f4f"; // wxd930ea5d5a258f4f 对应的密钥
    ...
    private class GetAccessTokenTask extends AsyncTask<Void, Void, GetAccessTokenResult> {
        ...
        protected void onPostExecute(GetAccessTokenResult result) {
            ...
            if (result.localRetCode == LocalRetCode.ERR_OK) {
                Toast.makeText(context, "微信支付结果：", Toast.LENGTH_LONG).show();
